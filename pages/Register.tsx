    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <button onClick={onLoginClick} className="font-medium text-teal-600 hover:text-teal-500">
            Sign in
          </button>
        </p>
      </div>
          ...
          <div className="mb-8 flex p-1 bg-gray-100 rounded-lg">
             <button
                ...
                className={`flex-1 flex items-center justify-center py-2 text-sm font-medium rounded-md transition-all ${
                    role === UserRole.CUSTOMER ? 'bg-white shadow-sm text-teal-600' : 'text-gray-500 hover:text-gray-700'
                }`}
             >
             ...
             <button
                ...
                className={`flex-1 flex items-center justify-center py-2 text-sm font-medium rounded-md transition-all ${
                    role === UserRole.PROVIDER ? 'bg-white shadow-sm text-teal-600' : 'text-gray-500 hover:text-gray-700'
                }`}
             >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm"
              />
            </div>
