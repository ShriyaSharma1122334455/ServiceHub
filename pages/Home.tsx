...
export const Home: React.FC<HomeProps> = ({ onNavigate, isLoggedIn }) => {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-black via-teal-900 to-emerald-900 py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581578731117-104f2a8d23e9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6">
            Home services, <span className="text-emerald-400">on demand.</span>
          </h1>
          ...
          <div className="flex justify-center space-x-4">
            <button 
              ...
              className="bg-white text-teal-800 px-8 py-3.5 rounded-xl font-bold text-lg shadow-lg hover:bg-teal-50 transition-all transform hover:-translate-y-1"
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {Object.values(ServiceCategory).map((service) => (
                    <div 
                        ...
                        className="group bg-slate-50 rounded-2xl p-6 text-center cursor-pointer hover:shadow-xl hover:bg-white transition-all border border-transparent hover:border-teal-100"
                    >
